/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c14d9ab1795b87cf25bbee3b0a3fed7b)
// Runtime types generated with workerd@1.20260526.1 2025-10-08 
interface __BaseEnv_Env {
    dispatch_kv: KVNamespace;
    dispatch: R2Bucket;
    offers: R2Bucket;
    EMI_API_KEY: string;
}
declare namespace Cloudflare {
    ...
    interface Env extends __BaseEnv_Env {
        [x: string]: string | URL | Request<unknown, CfProperties<unknown>>;
    }
}
interface Env extends __BaseEnv_Env { }
